...
async function createDefaultWebpackConfig(storybookBaseConfig, options) {
  var _options$presetsList, _options$presetsList2, _storybookBaseConfig$, _storybookBaseConfig$2;
  ...
  return _objectSpread(_objectSpread({}, storybookBaseConfig), {}, {
    ...
    resolve: _objectSpread(_objectSpread({}, storybookBaseConfig.resolve), {}, {
      fallback: _objectSpread({
        crypto: false,
        assert: false
      }, (_storybookBaseConfig$2 = storybookBaseConfig.resolve) === null || _storybookBaseConfig$2 === void 0 ? void 0 : _storybookBaseConfig$2.fallback)
    })
  });
}