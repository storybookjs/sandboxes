var u=(e=>typeof require!="undefined"?require:typeof Proxy!="undefined"?new Proxy(e,{get:(r,t)=>(typeof require!="undefined"?require:r)[t]}):e)(function(e){if(typeof require!="undefined")return require.apply(this,arguments);throw new Error('Dynamic require of "'+e+'" is not supported')});var a={};import{dedent as ve}from"ts-dedent";import{logger as P}from"@storybook/node-logger";import{dirname as Pe}from"path";import A from"path";import K from"fs";var T=new Set([".js",".jsx",".ts",".tsx",".cjs",".mjs"]);function ge(){return[...Array.from(T)]}var U=ge();function y(e){return U.map(r=>e.endsWith(r)?e:`${e}${r}`).find(r=>K.existsSync(r))}function H(e){return U.map(r=>({path:e.endsWith(r)?e:`${e}${r}`,ext:r})).find(r=>K.existsSync(r.path))}var V=!1;function $(e){if(V===!1){let{register:o}=u("esbuild-register/dist/node");V=!0,o({target:`node${process.version.slice(1)}`,format:"cjs",hookIgnoreNodeModules:!1,tsconfigRaw:`{
    ...
    }`})}let r=u(e);return typeof r=="object"&&r!==null&&typeof r.default<"u"?r.default:r}function ue(e){for(let r=0;r<e.length;r+=1){let t=H(e[r]);if(t)return t}}function h(e){let r=j(e);return r?$(r):null}function j(e){let r=Array.isArray(e)?e:[e],t=ue(r);return t?t.path:null}import{dedent as w}from"ts-dedent";import ye from"util-deprecate";import be from"glob";import v from"path";var xe=ye(()=>{},w`
  ...
  `)};function S(e){let r=`{${Array.from(T).join(",")}}`,t=i=>!!be.sync(v.resolve(e,`${i}${r}`)).length,o=t("main"),n=t("config");if(!o&&!n)throw new Error(w`
...
${r}`)}};async function Ce(e){if(e.type==="virtual"){let{type:t,name:o,...n}=e;return n}let r=e.name?e.name:e;return $(r)}async function Re(e,r,t){try{let o=e.name?e.name:e,n=e.options?e.options:{},s=await Ce(e);if(typeof s=="function"&&(s=s(t,n)),Array.isArray(s))return C(s,r+1,t);if(k(s)){let{addons:f,presets:c,...p}=s,i=Y(c,n,t),l=Y(f,n,t);return[...await C([...i],r+1,t),...await C([...l.map(Se(t))].filter(Boolean),r+1,t),{name:o,preset:p,options:n}]}throw new Error(ve`
    ...
    `)}catch(o){let n=r>0?`  Failed to load preset: ${JSON.stringify(e)} on level ${r}`:`  Failed to load preset: ${JSON.stringify(e)}`;return P.warn(n),P.error(o),[]}}async function C(e,r,t){return!e||!Array.isArray(e)||!e.length?[]:(r||P.info("=> Loading presets"),(await Promise.all(e.map(async o=>Re(o,r,t)))).reduce((o,n)=>o.concat(n),[]))}function G(e,r,t,o,n){let s=new Promise(f=>f(t));return e.length?e.reduce((f,{preset:c,options:p})=>{let i=c[r];if(!i)return f;if(typeof i=="function"){let l=i,d={preset:c,combinedOptions:{...n,...o,...p,presetsList:e,presets:{apply:async(m,g,x={})=>G(e,m,g,x,n)}}};return f.then(m=>l.call(d.preset,m,d.combinedOptions))}return f.then(l=>Array.isArray(l)&&Array.isArray(i)?[...l,...i]:k(l)&&k(i)?{...l,...i}:i)},s):s}async function Ee(e,r){let t=await C(e,0,r);return{apply:async(o,n,s={})=>G(t,o,n,s,r)}}async function Nr(e){let{corePresets:r=[],overridePresets:t=[],...o}=e,n=[...r,...q(e),...t],s=Oe(n);return s.length<n.length&&P.warn("Storybook now supports TypeScript natively. You can safely remove `@storybook/preset-typescript`."),Ee(s,o)}var{logger:N}=u("@storybook/node-logger"),D=e=>r=>{let t=r.name||r;return t&&t.includes(e)},Te=(e,r,t)=>{let o=e.findIndex(D("@storybook/addon-essentials")),n=e.findIndex(D(r.name)),s=e.findIndex(D(t.name));return n===-1&&r.inEssentials&&(n=o),s===-1&&t.inEssentials&&(s=o),n!==-1&&s!==-1&&n<=s},Fr=async({before:e,after:r,configFile:t,getConfig:o})=>{try{let n=await o(t);if(!n?.addons){N.warn("Unable to find 'addons' config in main Storybook config");return}if(!Te(n.addons,e,r)){let s=" (or '@storybook/addon-essentials')",f=`'${e.name}'${e.inEssentials?s:""}`,c=`'${r.name}'${r.inEssentials?s:""}`;N.warn(`Expected ${f} to be listed before ${c} in main Storybook config.`)}}catch{N.warn(`Unable to load config file: ${t}`)}};import{getEnvironment as je}from"lazy-universal-dotenv";import R from"path";import X from"find-up";var Mr=()=>{let e;try{let r=X.sync(".git",{type:"directory"});r&&(e=e||R.join(r,".."))}catch{}try{let r=X.sync(".svn",{type:"directory"});r&&(e=e||R.join(r,".."))}catch{}try{e=e||__dirname.split("node_modules")[0]}catch{}return e||process.cwd()},Z=e=>e.split(process.platform==="win32"?";":":").filter(Boolean).map(r=>R.resolve("./",r)),$e=/^\.{1,2}([/\\]|$)/;function Q(e){return $e.test(e)?e:`.${R.sep}${e}`}function Hr(e={}){let r=e.production?"production":"development",t={NODE_ENV:"production",NODE_PATH:a.NODE_PATH||"",STORYBOOK:a.STORYBOOK||"true",PUBLIC_URL:e.production?".":""};Object.keys(a).filter(c=>/^STORYBOOK_/.test(c)).forEach(c=>{t[c]=a[c]});let o=Object.entries(t).reduce((c,[p,i])=>Object.assign(c,{[p]:JSON.stringify(i)}),{}),{stringified:n,raw:s}=je({nodeEnv:t.NODE_ENV}),f={...t,...s};return f.NODE_PATH=Z(f.NODE_PATH||""),{stringified:{...o,...n},raw:f}}var Vr=e=>Object.entries(e).reduce((r,[t,o])=>(r[t]=JSON.stringify(o),r),{}),qr=e=>Object.entries(e).reduce((t,[o,n])=>(t[`process.env.${o}`]=JSON.stringify(n),t),{"process.env.XSTORYBOOK_EXAMPLE_APP":'""'});import Ie from"handlebars";function Yr(e,r){return Ie.compile(e)(r)}import Ae from"path";function et({configDir:e}){return S(e),h(Ae.resolve(e,"main"))}import{dedent as Ne}from"ts-dedent";async function ot(e){let r=await e.presets.apply("framework","",e);if(!r)throw new Error(Ne`
      You must specify a framework in '.storybook/main.js' config.

      https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#framework-field-mandatory
    `);return typeof r=="object"?r.name:r}function ee(e,r,t){if(!e)return null;let o=e.split(/[\s='"]+/),n=o.indexOf(t);return n===-1&&(n=o.indexOf(r)),n===-1?null:o[n+1]}import De from"path";import Fe from"fs-extra";var re={"@storybook/react":"react","@storybook/vue":"vue","@storybook/vue3":"vue3","@storybook/angular":"angular","@storybook/html":"html","@storybook/web-components":"web-components","@storybook/polymer":"polymer","@storybook/ember":"ember","@storybook/marko":"marko","@storybook/mithril":"mithril","@storybook/riot":"riot","@storybook/svelte":"svelte","@storybook/preact":"preact","@storybook/rax":"rax","@storybook/server":"server"},te=console,Le=({dependencies:e,devDependencies:r,peerDependencies:t},o)=>[Object.entries(e||{}).find(o),Object.entries(r||{}).find(o),Object.entries(t||{}).find(o)],_e=e=>{let[r,t,o]=Le(e,([c])=>re[c]),[n,s]=r||t||o||[],f=n?re[n]:void 0;return r&&t&&r[0]===t[0]&&te.warn(`Found "${r[0]}" in both "dependencies" and "devDependencies". This is probably a mistake.`),r&&o&&r[0]===o[0]&&te.warn(`Found "${r[0]}" in both "dependencies" and "peerDependencies". This is probably a mistake.`),{version:s,framework:f,frameworkPackage:n,renderer:f,rendererPackage:n}},Be=["ts","js","tsx","jsx","mjs","cjs"],F=(e,r)=>{let t=De.join(r,e),o=Be.find(n=>Fe.existsSync(`${t}.${n}`));return o?`${t}.${o}`:null},Me=e=>{let r=".storybook",t=e.scripts?.storybook;if(t){let o=ee(t,"-c","--config-dir");o&&(r=o)}return{configDir:r,mainConfig:F("main",r),previewConfig:F("preview",r),managerConfig:F("manager",r)}},pt=e=>{let r=_e(e),t=Me(e);return{...r,...t}};import{readJSON as oe}from"fs-extra";import{dirname as Je,join as Ke}from"path";import Ue from"find-up";import He from"resolve-from";import{logger as Ve}from"@storybook/node-logger";var qe=async e=>{let r=await Ue("package.json",{cwd:e.configDir});if(!r)return{};let t=Je(r),{dependencies:o=[],devDependencies:n=[]}=await oe(r)||{},s=Object.keys({...o,...n});return(await Promise.all(s.map(async c=>{try{let p=He(t,Ke(c,"package.json")),{storybook:i,name:l,version:d}=await oe(p)||{};if(i?.url)return{id:l,...i,version:d}}catch(p){if(p.code==="ERR_PACKAGE_PATH_NOT_EXPORTED")return;Ve.warn(`unable to find package.json for ${c}`);return}}))).filter(Boolean).reduce((c,p)=>({...c,[p.id]:{id:p.id.toLowerCase(),url:ne(p.url),title:p.title,version:p.version}}),{})},We=e=>fetch(`${e}/iframe.html`).then(async({ok:r,status:t})=>{if(r){if(t!==200)return!1;let o=await fetch(`${e}/iframe.html`,{headers:{Accept:"application/json"}});if(o.ok&&(await o.json().catch(n=>({}))).loginUrl)return!1}return r},()=>!1),ne=e=>e.replace(/\/$/,""),ze=e=>{let r=e.replace(/[A-Z]/g,t=>` ${t}`).replace(/[-_][A-Z]/gi,t=>` ${t.toUpperCase()}`).replace(/-/g," ").replace(/_/g," ");return`${r.substring(0,1).toUpperCase()}${r.substring(1)}`.trim()};async function yt(e){let r=await e.presets.apply("refs",await qe(e));return Object.entries(r).forEach(([t,o])=>{if(o.disable){delete r[t];return}r[t.toLowerCase()]={...o,id:t.toLowerCase(),title:o.title||ze(o.id||t),url:ne(o.url)}}),await Promise.all(Object.entries(r).map(async([t,o])=>{let n=await We(o.url);r[t]={...o,type:n?"server-checked":"unknown"}})),r}import L from"path";import{logger as Ye}from"@storybook/node-logger";import{dedent as Ge}from"ts-dedent";function kt({configDir:e}){let r=y(L.resolve(e,"addons")),t=y(L.resolve(e,"manager"));if((r||t)&&Ye.info("=> Loading custom manager config"),r&&t)throw new Error(Ge`
      You have both a "addons.js" and a "manager.js", remove the "addons.js" file from your configDir (${L.resolve(e,"addons")})`);return t||r}import _ from"path";import{dedent as Xe}from"ts-dedent";function Rt({configDir:e}){let r=y(_.resolve(e,"config")),t=y(_.resolve(e,"preview"));if(r&&t)throw new Error(Xe`
      You have both a "config.js" and a "preview.js", remove the "config.js" file from your configDir (${_.resolve(e,"config")})`);return t||r}import Ze from"chalk";function $t(e,r){console.log(Ze.cyan(e)),console.dir(r,{depth:null})}import Qe from"pretty-hrtime";var se=e=>Qe(process.hrtime(e)).replace(" ms"," milliseconds").replace(" s"," seconds").replace(" m"," minutes");var Dt=async(e,r,t)=>{let o=0,n,s=()=>{};e.get("/progress",(p,i)=>{let l=!1,d=()=>{l=!0,i.end()};i.on("close",d),!(l||i.writableEnded)&&(i.setHeader("Cache-Control","no-cache"),i.setHeader("Content-Type","text/event-stream"),i.setHeader("Connection","keep-alive"),i.flushHeaders(),s=m=>{l||i.writableEnded||(i.write(`data: ${JSON.stringify(m)}

`),i.flush(),m.value===1&&d())})});let f=(p,i,l)=>{o=Math.max(p,o);let d={value:o,message:i.charAt(0).toUpperCase()+i.slice(1)};if(i==="building"){let m=l&&l.match(/(\d+)\/(\d+)/)||[],g=parseInt(m[1],10),x=parseInt(m[2],10);!Number.isNaN(g)&&!Number.isNaN(x)&&(d.modules={complete:g,total:x},n=x)}o===1&&(t.cache&&t.cache.set("modulesCount",n),d.message||(d.message=`Completed in ${se(r)}.`)),s(d)},c=await t.cache?.get("modulesCount").catch(()=>{})||1e3;return{handler:f,modulesCount:c}};import B from"path";import er from"pkg-dir";function ie(e){let r=process.cwd(),t=er.sync(r),o;return t?o=B.resolve(t,"node_modules/.cache/storybook"):o=B.resolve(r,".cache/storybook"),B.join(o,e)}import rr from"file-system-cache";function M(e){return rr(e)}var Ht=M({basePath:ie("dev-server"),ns:"storybook"});import ae from"path";import{sync as J}from"pkg-dir";import b from"fs";var ce=(e,r={})=>Object.entries(r).reduce((t,[o,n])=>t.replace(new RegExp(`%${o}%`,"g"),n),e);function Yt(e,r){let t=b.readFileSync(`${J(__dirname)}/templates/base-preview-body.html`,"utf8"),o=ae.resolve(e,"preview-body.html"),n=t;return b.existsSync(o)&&(n=b.readFileSync(o,"utf8")+n),ce(n,r)}function Gt(e,r){let t=b.readFileSync(`${J(__dirname)}/templates/base-preview-head.html`,"utf8"),o=ae.resolve(e,"preview-head.html"),n=t;return b.existsSync(o)&&(n+=b.readFileSync(o,"utf8")),ce(n,r)}function Xt(){return`${J(__dirname)}/templates/preview.ejs`}var Qt=(e,r)=>Object.entries(r).reduce((t,[o,n])=>{let s=n.replace(/\\/g,"/").replace(/\$/g,"$$$");return t.replace(new RegExp(`{{${o}}}`,"g"),s)},e);import{makeRe as tr}from"picomatch";function pe(e){let r=tr(e,{fastpaths:!1,noglobstar:!1,bash:!1});if(!r.source.startsWith("^"))throw new Error(`Invalid glob: >> ${e} >> ${r}`);return e.startsWith("./")?new RegExp(["^\\.",e.startsWith("./**")?"":"[\\\\/]",r.source.substring(1)].join("")):r}import or from"fs";import O from"path";import{scan as nr}from"picomatch";import fe from"slash";var E="",le="**/*.@(mdx|stories.mdx|stories.tsx|stories.ts|stories.jsx|stories.js)",sr=(e,r)=>{try{return or.lstatSync(O.resolve(e,r)).isDirectory()}catch{return!1}},ir=({configDir:e,workingDir:r,directory:t})=>{let o=O.resolve(e,t),n=O.relative(r,o);return Q(n)},ar=(e,{configDir:r,workingDir:t})=>{let o;if(typeof e=="string"){let p=nr(e);if(p.isGlob){let i=p.prefix+p.base,l=p.glob;o={titlePrefix:E,directory:i,files:l}}else sr(r,e)?o={titlePrefix:E,directory:e,files:le}:o={titlePrefix:E,directory:O.dirname(e),files:O.basename(e)}}else o={titlePrefix:E,files:le,...e};let n=fe(o.files),{directory:s}=o,f=fe(ir({configDir:r,workingDir:t,directory:s})).replace(/\/$/,""),c=pe(`${f}/${n}`);return{...o,directory:f,importPathMatcher:c}},po=(e,r)=>e.map(t=>ar(t,r));import cr from"fs-extra";async function mo(e){return cr.readFile(e,{encoding:"utf8"})}import de from"path";import{sync as pr}from"find-up";var bo=(e,r)=>{let t=pr("package.json",{cwd:e});if(!t)throw new Error(`Could not find package.json in: ${e}`);let o=de.dirname(t);return de.join(o,"dist","esm",r)};function ho(){let{NODE_OPTIONS:e,NODE_PRESERVE_SYMLINKS:r}=a;return!!r||e?.includes("--preserve-symlinks")}export{T as boost,Ht as cache,Fr as checkAddonOrder,M as createFileSystemCache,Oe as filterPresetsConfig,bo as findDistEsm,qe as getAutoRefs,ir as getDirectoryFromWorkingDir,ot as getFrameworkName,y as getInterpretedFile,H as getInterpretedFileWithExt,Ee as getPresets,Yt as getPreviewBodyTemplate,Gt as getPreviewHeadTemplate,Xt as getPreviewMainTemplate,Mr as getProjectRoot,yt as getRefs,ee as getStorybookConfiguration,pt as getStorybookInfo,pe as globToRegexp,Yr as handlebars,$ as interopRequireDefault,Qt as interpolate,ho as isPreservingSymlinks,Nr as loadAllPresets,q as loadCustomPresets,Hr as loadEnvs,et as loadMainConfig,kt as loadManagerOrAddonsFile,Re as loadPreset,Rt as loadPreviewOrConfigFile,$t as logConfig,Z as nodePathsToArray,po as normalizeStories,ar as normalizeStoriesEntry,Q as normalizeStoryPath,mo as readTemplate,we as resolveAddonName,ie as resolvePathInStorybookCache,h as serverRequire,j as serverResolve,Vr as stringifyEnvs,qr as stringifyProcessEnvs,Dt as useProgressReporting,S as validateConfigurationFiles};
