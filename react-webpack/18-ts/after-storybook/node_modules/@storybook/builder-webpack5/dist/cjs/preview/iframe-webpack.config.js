...
}, ['addons', 'api', 'store', 'channels', 'channel-postmessage', 'channel-websocket', 'components', 'core-events', 'router', 'theming', 'preview-web', 'client-api', 'client-logger'].reduce(function (acc, sbPackage) {
...
var _default = async function _default(options) {
  ...
  return _objectSpread(_objectSpread({
    ...
    experiments: _objectSpread({}, lazyCompilationConfig)
  });
};
