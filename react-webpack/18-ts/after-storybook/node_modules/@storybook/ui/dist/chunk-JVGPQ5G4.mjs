...
// ../theming/dist/chunk-6S2C2YZ5.mjs
init_define_process_env();
...
var { LOGLEVEL, console: console2 } = import_global.default;
var levels = {
  trace: 1,
  debug: 2,
  info: 3,
...
var logger = {
  trace: (message, ...rest) => currentLogLevelNumber <= levels.trace && console2.trace(message, ...rest),
  debug: (message, ...rest) => currentLogLevelNumber <= levels.debug && console2.debug(message, ...rest),
  info: (message, ...rest) => currentLogLevelNumber <= levels.info && console2.info(message, ...rest),
  warn: (message, ...rest) => currentLogLevelNumber <= levels.warn && console2.warn(message, ...rest),
  error: (message, ...rest) => currentLogLevelNumber <= levels.error && console2.error(message, ...rest),
  log: (message, ...rest) => currentLogLevelNumber < levels.silent && console2.log(message, ...rest)
};
...
var init_define_process_env2 = __esm({
  "<define:process.env>"() {
  }
});
var require_window2 = __commonJS2({
  "../../node_modules/global/window.js"(exports, module) {
...
function withTheme(Component) {
  ...
  var render = function render2(props, ref) {
    var theme3 = (0, import_react5.useContext)(ThemeContext);
    return /* @__PURE__ */ (0, import_react5.createElement)(Component, _extends({
      theme: theme3,
      ref
    }, props));
  };
  var WithTheme = /* @__PURE__ */ (0, import_react5.forwardRef)(render);
...
if (true) {
  ...
  if (isBrowser2 && !isJest) {
    globalContext = typeof globalThis !== "undefined" ? globalThis : isBrowser2 ? window : window;
