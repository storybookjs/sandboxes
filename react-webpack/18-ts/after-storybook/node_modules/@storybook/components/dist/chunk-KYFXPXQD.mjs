...
import {
  require_markdown
} from "./chunk-MKHR4UXA.mjs";
import {
  require_yaml
} from "./chunk-O7QRV33O.mjs";
import {
  require_tsx
} from "./chunk-CVZ7TKSQ.mjs";
import {
  require_typescript
} from "./chunk-4SP4JLIZ.mjs";
import {
  require_core
} from "./chunk-665R7RDF.mjs";
import {
  require_markup
} from "./chunk-32OKXK37.mjs";
import {
  require_jsx
} from "./chunk-AFOO5U5O.mjs";
import {
  require_bash
} from "./chunk-G6QJRVIR.mjs";
import {
  require_css
} from "./chunk-XWB7NN7F.mjs";
import {
  require_js_extras
} from "./chunk-EX2OSMKF.mjs";
import {
  require_json
} from "./chunk-TJRX2SHS.mjs";
import {
  require_graphql
} from "./chunk-GA4U2A3L.mjs";
import {
  __toESM,
...
var ActionBar = ({ actionItems, ...props }) => /* @__PURE__ */ React3.createElement(Container, {
  ...props
}, actionItems.map(({ title, className, onClick, disabled }, index) => /* @__PURE__ */ React3.createElement(ActionButton, {
  key: index,
  className,
  onClick,
  disabled
...
var GlobalScrollAreaStyles = lazy(() => import("./GlobalScrollAreaStyles-ZRFAWFJL.mjs"));
var OverlayScrollbars = lazy(() => import("./OverlayScrollbars-NW2AJMSO.mjs"));
var Scroller = ({ horizontal, vertical, ...props }) => /* @__PURE__ */ React4.createElement(Suspense, {
  fallback: /* @__PURE__ */ React4.createElement("div", {
    ...props
  })
}, /* @__PURE__ */ React4.createElement(GlobalScrollAreaStyles, null), /* @__PURE__ */ React4.createElement(OverlayScrollbars, {
  options: { scrollbars: { autoHide: "leave" } },
  ...props
}));
var ScrollArea = styled2(Scroller)(
...
// src/syntaxhighlighter/syntaxhighlighter.tsx
var { navigator, document, window: globalWindow } = import_global.default;
...
var UnstyledScroller = ({
  children,
  className
}) => /* @__PURE__ */ React5.createElement(ScrollArea, {
  horizontal: true,
  vertical: true,
  className
}, children);
var Scroller2 = styled3(UnstyledScroller)(
  {
    position: "relative"
  },
  ({ theme }) => themedSyntax(theme)
);
var Pre = styled3.pre(({ theme, padded }) => ({
  display: "flex",
  justifyContent: "flex-start",
  margin: 0,
  padding: padded ? theme.layoutMargin : 0
}));
var Code = styled3.div(({ theme }) => ({
  flex: 1,
  paddingLeft: 2,
...
var SyntaxHighlighter2 = ({
  ...
  return /* @__PURE__ */ React5.createElement(Wrapper, {
    bordered,
    padded,
    showLineNumbers,
    className
  }, /* @__PURE__ */ React5.createElement(Scroller2, null, /* @__PURE__ */ React5.createElement(prism_light_default, {
    ...
    ...rest,
    renderer
  }, highlightableCode)), copyable ? /* @__PURE__ */ React5.createElement(ActionBar, {
