...
// ../../node_modules/react-popper-tooltip/dist/esm/react-popper-tooltip.js
var TooltipContext = /* @__PURE__ */ React6.createContext({});
...
var Tooltip = /* @__PURE__ */ function(_Component) {
  ...
  _proto.render = function render() {
    ...
    return /* @__PURE__ */ React6.createElement(TooltipContext.Provider, {
...
var TooltipTrigger = /* @__PURE__ */ function(_Component) {
  ...
  _proto.render = function render() {
    ...
    var popper = /* @__PURE__ */ React6.createElement(Popper, _extends({
      ...
      return /* @__PURE__ */ React6.createElement(Tooltip, _extends({
        arrowProps,
    ...
    return /* @__PURE__ */ React6.createElement(Manager, null, /* @__PURE__ */ React6.createElement(Reference, {
...
var Wrapper = styled.div(
  ...
  ({ theme, color, hasChrome }) => hasChrome ? {
    background: theme.color[color] || color || theme.base === "light" ? lighten(theme.background.app) : theme.background.app,
    filter: `
...
var Tooltip2 = ({
  ...
  return /* @__PURE__ */ React7.createElement(Wrapper, {
    hasChrome,
    placement,
    ref: tooltipRef,
    ...props,
    color
  }, hasChrome && /* @__PURE__ */ React7.createElement(Arrow, {
    placement,
    ref: arrowRef,
    ...arrowProps,
    color
...
var WithTooltipPure = ({
  ...
  return /* @__PURE__ */ React8.createElement(react_popper_tooltip_default, {
    placement,
    trigger,
    modifiers,
    tooltipShown,
    ...
    }) => /* @__PURE__ */ React8.createElement(Tooltip2, {
      hasChrome,
      placement: tooltipPlacement,
      tooltipRef,
      arrowRef,
  ...
  }, ({ getTriggerProps, triggerRef }) => /* @__PURE__ */ React8.createElement(Container, {
    ref: triggerRef,
    ...getTriggerProps(),
    ...props
  }, children));
...
var WithToolTipState = ({ startOpen, onVisibilityChange: onChange, ...rest }) => {
  const [tooltipShown, setTooltipShown] = useState4(startOpen || false);
  const onVisibilityChange = useCallback3(
    (visibility) => {
  ...
  return /* @__PURE__ */ React8.createElement(WithTooltipPure, {
    ...rest,
    tooltipShown,
    onVisibilityChange
  });
