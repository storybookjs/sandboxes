...
declare const decorateAction: (_decorators: DecoratorFunction[]) => () => void;
declare const decorate: (_decorators: DecoratorFunction[]) => () => {
    action: () => void;
    actions: () => void;
    withActions: () => void;
};

declare const withActions: (...args: any) => any;

export { ADDON_ID, ActionDisplay, ActionOptions, ActionsFunction, ActionsMap, CYCLIC_KEY, DecoratorFunction, EVENT_ID, HandlerFunction, PANEL_ID, PARAM_KEY, action, actions, config, configureActions, decorate, decorateAction, withActions };
