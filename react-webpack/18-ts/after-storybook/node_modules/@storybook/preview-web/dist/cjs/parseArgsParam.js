...
const validateArgs = (key = '', value) => {
  ...
  if ((0, _isPlainObject.default)(value)) return Object.entries(value).every(([k, v]) => validateArgs(k, v));
  return false;
};
...
const parseArgsParam = argsString => {
  ...
  return Object.entries(_qs.default.parse(parts.join(';'), QS_OPTIONS)).reduce((acc, [key, value]) => {
