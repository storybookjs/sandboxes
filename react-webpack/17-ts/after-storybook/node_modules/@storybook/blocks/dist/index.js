...
var Label = import_theming8.styled.label(({ theme }) => ({
  ...
  "input:checked ~ span:last-of-type, input:not(:checked) ~ span:first-of-type": {
    ...
    boxShadow: theme.base === "light" ? `${(0, import_polished4.opacify)(0.1, theme.appBorderColor)} 0 0 2px` : `${theme.appBorderColor} 0 0 0 1px`,
    color: theme.color.defaultText,
    padding: "7px 15px"
  }
}));
...
var SelectWrapper = import_theming13.styled.span(({ theme }) => ({
  display: "inline-block",
  lineHeight: "normal",
  overflow: "hidden",
  position: "relative",
