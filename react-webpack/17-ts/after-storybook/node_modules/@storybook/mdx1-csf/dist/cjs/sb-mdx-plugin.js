...
function extractExports(root, options) {
  ...
  const fullJsx = ['import { assertIsFn } from "@storybook/addon-docs";', defaultJsx, ...storyExports, `const componentMeta = ${stringifyMeta(metaExport)};`, wrapperJs, 'export default componentMeta;'].join('\n\n');
  return fullJsx;
}
