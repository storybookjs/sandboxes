...
export const teardownRenderToDOM = jest.fn();
...
export const getProjectAnnotations = jest.fn(() => projectAnnotations);
...
export const waitForEvents = (events, predicate = () => true, debugLabel) => {
...
export const waitForRenderPhase = phase => {
  ...
  return waitForEvents([STORY_RENDER_PHASE_CHANGED], ({
    newPhase
