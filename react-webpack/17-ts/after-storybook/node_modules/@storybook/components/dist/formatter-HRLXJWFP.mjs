...
var require_parser_html = __commonJS({
  "node_modules/prettier/parser-html.js"(exports, module) {
    init_define_process_env();
    !function(e, t) {
      "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : ((e = "undefined" != typeof globalThis ? globalThis : e || self).prettierPlugins = e.prettierPlugins || {}, e.prettierPlugins.html = t());
    }(exports, function() {
      "use strict";
      var e = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof window ? window : "undefined" != typeof self ? self : {};
      function t(e2) {
        var t2 = { exports: {} };
      ...
      const I = "undefined" != typeof window && window, P = "undefined" != typeof self && "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope && self;
      var R = void 0 !== e && e || I || P, O = Object.defineProperty({ dashCaseToCamelCase: u, splitAtColon: c, splitAtPeriod: l, visitValue: h, isDefined: d, noUndefined: m, ValueTransformer: f, SyncAsync: g, error: E, syntaxError: C, isSyntaxError: S, getParseErrors: y, escapeRegExp: F, utf8Encode: A, stringify: b, resolveForwardRef: w, isPromise: k, Version: x, global: R }, "__esModule", { value: true }), L = t(function(e2, t2) {
      ...
      const { ParseSourceSpan: ln, ParseLocation: Dn, ParseSourceFile: pn } = B, { inferParserByLanguage: hn } = Ft, { HTML_ELEMENT_ATTRIBUTES: dn, HTML_TAGS: mn, isUnknownNamespace: fn } = rr, { hasPragma: gn } = nr, { Node: En } = cr, { parseIeConditionalComment: Cn } = pr, { locStart: Tn, locEnd: _n } = hr;
          ...
          visit(e3) {
            ((e4) => {
              ...
              if ("element" === e4.type) {
                ...
                !e4.namespace || e4.namespace === t3.implicitNamespacePrefix || fn(e4) ? e4.tagDefinition = t3 : e4.tagDefinition = p2("");
              }
            })(e3), ((e4) => {
              if ("element" === e4.type && (!r2 || e4.namespace && e4.namespace !== e4.tagDefinition.implicitNamespacePrefix && !fn(e4) || (e4.name = f2(e4.name, (e5) => e5 in mn)), n2)) {
  ...
  "node_modules/prettier/standalone.js"(exports, module) {
    ...
    !function(e, t) {
      ...
      function A(e2, t2) {
        ...
        for (var C2 = 0, A2 = 0; A2 < s2.length; A2++) {
          var F2 = s2[A2], x2 = F2.oldStart + F2.offset + C2 - 1;
        ...
        if (r2)
          ...
          o2 && (i2.push(""), u2.push("\n"));
        for (var P2 = 0; P2 < i2.length - 1; P2++)
          i2[P2] = i2[P2] + u2[P2];
        return i2.join("");
      }
      var F = Object.defineProperty({ applyPatch: b, applyPatches: C }, "__esModule", { value: true }), x = N, S = P, w = O, T = function(e2, t2, n2, r2, o2, i2) {
      ...
      function O(e2, t2, n2, r2, o2, i2, u2) {
        return P(N(e2, t2, n2, r2, o2, i2, u2));
      }
      ...
      var bn = { isConcat: sn, getDocParts: an, willBreak: function(e2) {
        return fn(e2, dn, false);
      }, traverseDoc: ln, findInDoc: fn, mapDoc: pn, propagateBreaks: function(e2) {
      ...
      var CE = function(e2, t2, n2) {
        ...
        const C2 = XD(c2[h2 ? 1 : 0]).node, v2 = !QD(C2) && u2(C2), A2 = [m2(c2[0]), h2 ? c2.slice(1, 2).map(m2) : "", v2 ? lE : "", function(e3) {
        ...
        }() ? pE(A2) : [gE(y2) || v2 ? hE : "", dE([y2, A2])], mE("member-chain", x2);
      };
      ...
      const { printComments: EC } = up, { printString: bC, printNumber: CC } = rn, { isNumericLiteral: vC, isSimpleNumber: AC, isStringLiteral: FC, isStringPropSafeToUnquote: xC, rawText: SC } = pd, { printAssignment: wC } = ib, TC = /* @__PURE__ */ new WeakMap();
      function BC(e2, t2, n2) {
        ...
        if ("consistent" === t2.quoteProps && !TC.has(o2)) {
          const e3 = (o2.properties || o2.body || o2.members).some((e4) => !e4.computed && e4.key && FC(e4.key) && !xC(e4, t2));
          TC.set(o2, e3);
        }
      ...
      var cF = { printTernary: function(e2, t2, n2) {
        ...
        }(e2), A2 = (F2 = [sF(e2, 0, n2), g2 ? l2 : nF(l2), o2 && C2 && !v2 ? eF : ""], f2 === D2 ? tF(F2, { shouldBreak: b2 }) : b2 ? [F2, uF] : F2);
        var F2;
        return d2 || v2 ? tF([nF([eF, A2]), eF]) : A2;
      } };
      ...
      var qB = { print: function(e2, t2, n2) {
        ...
        switch (r2.type) {
          ...
          case "media-query-list": {
            ...
            }, "nodes"), PT(IT(TT(BT, t3)));
          }
          case "media-query":
            return [TT(" ", e2.map(n2, "nodes")), KT(e2, r2) ? "" : ","];
          case "media-type":
          ...
          case "media-unknown":
            return r2.value;
          case "selector-root":
            return PT([HT(e2, "custom-selector") ? [$T(e2, "css-atrule").customSelector, BT] : "", TT([",", HT(e2, ["extend", "custom-selector", "nest"]) ? BT : kT], e2.map(n2, "nodes"))]);
          ...
          case "selector-pseudo":
            return [WT(r2.value), wT(r2.nodes) ? ["(", TT(", ", e2.map(n2, "nodes")), ")"] : ""];
          ...
          case "value-comma_group": {
            ...
            for (let n3 = 0; n3 < r2.groups.length; ++n3) {
              ...
              if (UT(e2, "calc") && (iB(c3) || iB(m2) || uB(c3) || uB(m2)) && hB(m2))
                continue;
              const C2 = (iB(c3) || uB(c3)) && 0 === n3 && ("value-number" === m2.type || m2.isHex) && o2 && BB(o2) && !hB(m2), v2 = g2 && "value-func" === g2.type || g2 && SB(g2) || "value-func" === c3.type || SB(c3), A2 = "value-func" === m2.type || SB(m2) || i3 && "value-func" === i3.type || i3 && SB(i3);
              if (rB(m2) || rB(c3) || UT(e2, "calc") || C2 || !(oB(m2) && !v2 || oB(c3) && !A2 || iB(m2) && !v2 || iB(c3) && !A2 || uB(m2) || uB(c3)) || !(hB(m2) || E2 && (!i3 || i3 && sB(i3))))
                if (vB(c3)) {
          ...
          case "value-paren_group": {
            ...
            if (o2 && lB(o2) && (1 === r2.groups.length || r2.groups.length > 0 && "value-comma_group" === r2.groups[0].type && r2.groups[0].groups.length > 0 && "value-word" === r2.groups[0].groups[0].type && r2.groups[0].groups[0].value.startsWith("data:")))
              return [r2.open ? n2("open") : "", TT(",", e2.map(n2, "groups")), r2.close ? n2("close") : ""];
            if (!r2.open) {
            ...
            const i2 = CB(e2), u2 = ke(r2.groups), s2 = u2 && "value-comment" === u2.type, a2 = gB(r2, o2), c2 = PT([r2.open ? n2("open") : "", IT([NT, TT([",", BT], e2.map((e3) => {
        ...
        class s2 {
          static create({ isHost: e3, type: t3, isComponent: r3, selector: o3, exportAs: i3, changeDetection: u3, inputs: a3, outputs: c3, host: l3, providers: p2, viewProviders: f2, queries: d2, guards: h2, viewQueries: m2, entryComponents: g2, template: y2, componentViewType: D2, rendererType: E2, componentFactory: b2 }) {
            ...
            null != l3 && Object.keys(l3).forEach((e4) => {
              ...
              null === r4 ? A2[e4] = t4 : null != r4[1] ? v2[r4[1]] = t4 : null != r4[2] && (C2[r4[2]] = t4);
            });
            const F2 = {};
            null != a3 && a3.forEach((e4) => {
            ...
            return null != c3 && c3.forEach((e4) => {
              const t4 = yI.splitAtColon(e4, [e4, e4]);
              x2[t4[0]] = t4[1];
            }), new s2({ isHost: e3, type: t3, isComponent: !!r3, selector: o3, exportAs: i3, changeDetection: u3, inputs: F2, outputs: x2, hostListeners: C2, hostProperties: v2, hostAttributes: A2, providers: p2, viewProviders: f2, queries: d2, guards: h2, viewQueries: m2, entryComponents: g2, template: y2, componentViewType: D2, rendererType: E2, componentFactory: b2 });
          }
      ...
      var LI = { isVueEventBindingExpression: function(e2) {
        const t2 = e2.trim();
      ...
      const { builders: { ifBreak: qL, line: WL, softline: UL, hardline: zL, join: HL } } = Rn, { isEmptyNode: GL, getLast: JL, hasEndComments: XL } = BL, { printNextEmptyLine: YL, alignWithSpaces: KL } = $L;
      ...
      var lM = { preprocess: OL, embed: DL, print: function(e2, t2, n2) {
        const r2 = e2.getValue(), o2 = [];
...
var formatter = memoize(2)((type, source) => {
  if (type === false) {
    return source;
  }
